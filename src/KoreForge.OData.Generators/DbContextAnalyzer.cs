...
namespace KoreForge.OData.Generators;
...
internal static class DbContextAnalyzer
{
    ...
    private const string ODataIgnoreFullName = "KoreForge.OData.Attributes.ODataIgnoreAttribute";
    private const string ODataAuthorizeFullName = "KoreForge.OData.Attributes.ODataAuthorizeAttribute";
