...
using KoreForge.OData.Generators;
using Microsoft.CodeAnalysis;
using Microsoft.CodeAnalysis.CSharp;
using Xunit;

namespace KoreForge.OData.Tests;
...
using KoreForge.OData.Attributes;
...
[assembly: GenerateODataFor(typeof(KoreForge.Data.AlertsDbContext))]
...
namespace KoreForge.Data
{
    public class AlertsDbContext : DbContext
    {
        ...
        public DbSet<KoreForge.Data.Alerts.Notification.Channel> Channels { get; set; } = null!;
        public DbSet<KoreForge.Data.Alerts.Notification.Priority> Priorities { get; set; } = null!;
        public DbSet<KoreForge.Data.Alerts.AuditTrail> AuditTrails { get; set; } = null!;
    }
}
";
...
";
    ...
    private static (Dictionary<string, string> output, ImmutableArray<Diagnostic> diagnostics) RunGenerator(string source)
    {
        ...
        // Add KoreForge.OData.Attributes
        var kfODataAssembly = typeof(KoreForge.OData.Attributes.ODataIgnoreAttribute).Assembly;
